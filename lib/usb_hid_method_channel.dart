...
class MethodChannelUsbHid extends UsbHidPlatform {
  ...
  @visibleForTesting
  static const EventChannel inputReportsChannel = EventChannel('usb_hid/input_reports');
  ...
  Future<int> sendOutputReport(HidDeviceHandle handle, int reportId, Uint8List data) async {
    final bytesWritten = await methodChannel.invokeMethod<int>('sendOutputReport', {
