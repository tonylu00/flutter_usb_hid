...
abstract class UsbHidPlatform extends PlatformInterface {
  ...
  Future<int> sendOutputReport(HidDeviceHandle handle, int reportId, Uint8List data);

  /// Send a feature report (usually control transfer).
  Future<void> sendFeatureReport(HidDeviceHandle handle, int reportId, Uint8List data);

  /// Read a feature report from the device.
  Future<Uint8List?> getFeatureReport(HidDeviceHandle handle, int reportId, int reportLength);
